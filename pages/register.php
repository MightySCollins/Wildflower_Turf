...
<head>
    ...
    <title><?php echo COMPANY_NAME ?> - Registration</title>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input class="form-control" id="login_input_password_new" placeholder="Password"
                                       name="user_password_new" type="password" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input class="form-control" id="user_password_repeat" placeholder="Password again"
                                       name="user_password_repeat" type="password" autocomplete="off">
                            </div>
                            <input type="submit" class="btn btn-lg btn-success btn-block" name="register"
                                   value="Register"/>
                        </fieldset>
                    </form>
                    <br><br><a class="btn btn-primary" href="index.php">Return to login</a>
                </div>
            </div>
        </div>
    </div>
